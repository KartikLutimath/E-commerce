    ...
    <footer className="bg-gray-50 pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          <div>
            <h3 className="text-lg font-medium mb-6">ELEGANCE</h3>
            <p className="text-sm text-gray-600 mb-6 max-w-xs">
              Crafting premium products with a focus on minimalism, quality, and timeless design.
            </p>
          </div>

          <div>
            <h3 className="text-sm font-medium uppercase tracking-wider mb-6">Shopping</h3>
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/collections" className="text-sm text-gray-600 hover:text-black transition-colors">
                  Collections
                </Link>
              </li>
              <li>
                <Link to="/products/new" className="text-sm text-gray-600 hover:text-black transition-colors">
                  New Arrivals
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/returns" className="text-sm text-gray-600 hover:text-black transition-colors">
                  Returns
                </Link>
              </li>
              <li>
